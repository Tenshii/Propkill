...
function DrawNewHUD()
	...
	draw.RoundedBox(4, ScrW()*0.029, ScrH()*0.838, math.Clamp( LocalPlayer():Health(), 0.1, 100 )*2.5, 20, Color(129, 183, 1, 255))
	...
	draw.RoundedBox(4, ScrW()*0.029, ScrH()*0.879, math.Clamp( KDR, 0.1, 4 )*62.5, 20, Color(193, 106, 6, 255))
